                ...
                <div className="message-page-main-area">
                    <div className="message-page-left-area">
                        <div className="message-page-left-area-upper">
                            <div style={{margin: "auto"}}>{profiledata && profiledata.userName}</div>
                        ...
                        <div className="message-page-left-area-bottom">
                            {users.map((u,index)=>
                                ...
                                <MessagesPageUsers  name={u.name} lastMessage="Sent you a message"
                                                    time="?h" profilePicture={u.ppLink}/>
                                </div>
                            )}
                    ...
                    {messagesState.length?
                        <div>
                            ...
                            <MessageArea userName={selectedUserBasic && selectedUserBasic.name} pp={selectedUserBasic && selectedUserBasic.ppLink} >
                                {messagesState && messagesState.map((m,index)=>{
